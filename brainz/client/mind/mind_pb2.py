...
_USER_GENDER = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="MALE", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="FEMALE", index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="OTHER", index=2, number=2, options=None, type=None),
    ],
...
_SNAPSHOT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="color_image",
            full_name="Snapshot.color_image",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="depth_image",
            full_name="Snapshot.depth_image",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
Pose = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        Rotation=_reflection.GeneratedProtocolMessageType(
            "Rotation",
            (_message.Message,),
            dict(
...
ColorImage = _reflection.GeneratedProtocolMessageType(
    "ColorImage",
    (_message.Message,),
    dict(
...
DepthImage = _reflection.GeneratedProtocolMessageType(
    "DepthImage",
    (_message.Message,),
    dict(
...
Feelings = _reflection.GeneratedProtocolMessageType(
    "Feelings",
    (_message.Message,),
    dict(
